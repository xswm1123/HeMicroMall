...
@interface BaseViewController : UIViewController<UIAlertViewDelegate,CLLocationManagerDelegate,WKUIDelegate,WKNavigationDelegate,WKScriptMessageHandler,UIWebViewDelegate,UIScrollViewDelegate>
